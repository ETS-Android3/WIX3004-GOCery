...
public class MemberCardLVAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MemberCardLVAdapter.ViewHolder viewHolder; // view lookup cache stored in tag
        if (convertView == null) {
            // If there's no view to re-use, inflate a brand new view for row
            viewHolder = new MemberCardLVAdapter.ViewHolder();
            ...
            viewHolder = (MemberCardLVAdapter.ViewHolder) convertView.getTag();
        }
