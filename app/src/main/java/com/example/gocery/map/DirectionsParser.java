...
public class DirectionsParser {
    ...
    public List<Route> parse(JSONObject jObject) {
        ...
        List<Route> routesTest = new ArrayList<>();

        JSONArray jRoutes = null;
        JSONArray jGeocode = null;
        ...
        try {
            ...
            jGeocode = jObject.getJSONArray("geocoded_waypoints");
            ...
            for (int i = 0; i < jRoutes.length(); i++) {
                ...
                for (int j = 0; j < jLegs.length(); j++) {
                    ...
                    String destination = ((JSONObject) jGeocode.get(j+1)).get("place_id").toString();
                    ...
                    route.setCoordinates(pathList);
                    routesTest.add(route);
                }
            }
