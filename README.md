...
| ID |            Module            |                             Function                             |                                                                 Function Brief  Description                                                                 |
|:--:|:----------------------------:|:----------------------------------------------------------------:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------:|
|  1 |            General           | Log in                                                           | Allow users to log into their account and into their own user profiles                                                                                      |
|    |                              | Log out                                                          | Allow users to logout of their account                                                                                                                      |
|    |                              | Register account                                                 | Allow users to register new account                                                                                                                         |
|    |                              | Account settings                                                 | Allows members to update their account details (display name, password)                                                                                     |
|  2 |    Grocery List Management   | Manage grocery list                                              | Enables users within the household to add/remove items from the grocery list                                                                                |
|    |                              | Complete Shopping                                                | Enable the user to complete a shopping trip by saving the checked grocery items in a single trip data                                                       |
|    |                              | Display Completed Shopping Trips                                 | Display to the user all the shopping trip that has been completed                                                                                           |
|    |                              | Attach image and location                                        | Users can attach images of the groceries, as well as the location or store of where they can be bought                                                      |
|  3 | Household Account Management | Manage user profiles                                             | Enables the admin to add, remove, edit user profiles (members) from the household. Admins can also appoint the members as household representatives.        |
|  4 |          Receipt OCR         | Scan receipts                                                    | Scan receipts from images taken with the camera or directly taken from the gallery.                                                                         |
|    |                              | Extract information from receipts using OCR                      | Information such as the total cost, items, cost per item, etc. are extracted from receipts.                                                                 |
|  5 |        Expense Tracker       | Manage (add, update, view, delete) expense records               | Enable user to add expense records such as their name, purchase date, type and total cost.                                                                  |
|    |                              | View overview of expenses                                        | Visualise expense records overview based on expense types in a chart manner                                                                                 |
|  5 |   Card & Voucher Management  | Manage household member card                                     | Enable user to add and remove member card information for purchases at official stores. Therefore, the whole family can share them.                         |
|    |                              | Attach gift vouchers or discounts                                | Enable user to add available vouchers and discounts. The used and expired vouchers will be automatically archived.                                          |
|  6 |   Route Planning Management  | Display graphical map.                                           | Displays an interactive map for the user.                                                                                                                   |
|    |                              | Display shortest path to travel between multiple grocery shops.  | Users will be able to list out the grocery shops that they plan to visit, and the application will display the recommended route and estimated time taken.  |
|    |                              | Open external applications to route user                         | If user needs turn-by-turn navigation, the application will offer to open an external application such as Google Map to guide the user straight away.       |
